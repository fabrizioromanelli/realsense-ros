...
configurable_parameters = [{'name': 'camera_name',                  'default': 'aruco', 'description': 'camera unique name'},
                           ...
                           {'name': 'infra_height',                 'default': '480', 'description': 'infra height'},
                           {'name': 'enable_infra1',                'default': 'false', 'description': 'enable infra1 stream'},
                           {'name': 'enable_infra2',                'default': 'false', 'description': 'enable infra2 stream'},
                           {'name': 'infra_rgb',                    'default': 'false', 'description': 'enable infra2 stream'},
                           {'name': 'fisheye_width',                'default': '848', 'description': 'fisheye width'},
                           {'name': 'fisheye_height',               'default': '800', 'description': 'fisheye height'},
                           ...
                           {'name': 'color_fps',                    'default': '30.0', 'description': ''},                           
                           ...
                           {'name': 'hold_back_imu_for_frames',     'default': 'false', 'description': 'Hold the Imu messages back while processing the images'},
                          ]
